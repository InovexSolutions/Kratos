  ...
  <div class="min-h-screen bg-gray-900 text-gray-100 p-8">
    <div class="max-w-4xl mx-auto">
      ...
      <div class="bg-gray-800 rounded-lg p-6 mb-8">
        ...
        <!-- Order Items -->
        <div v-for="(item, index) in order.items" :key="index" class="bg-gray-700/50 rounded-lg p-4 mb-4">
          ...
          <div class="grid grid-cols-2 gap-4 text-sm mb-4">
            <div v-for="(value, key) in item.configuration" :key="key" class="bg-gray-600/20 p-2 rounded">
          ...
          <div class="border-t border-gray-600/50 pt-3">
            <div
              v-for="modifier in item.plan.pricingModel.modifiers" :key="modifier.field"
      ...
      <div id="stripe-element" class="bg-gray-800 rounded-lg p-6" />

      <!-- Payment Actions -->
      <div class="mt-6 flex justify-end gap-4">
        <button class="bg-purple-600 hover:bg-purple-700 px-6 py-3 rounded-lg font-semibold" @click="handlePayment">
          Pay Now
        </button>
        <button class="bg-gray-700 hover:bg-gray-600 px-6 py-3 rounded-lg" @click="$router.back()">
          Cancel
        </button>
      </div>
    </div>
